...
// make it a Stream
util.inherits(WebsocketMessageObject, CombinedStream);

/* 
 * @constructor
 * @param {Object} options - Properties to be added/overriden for WebsocketMessageObject and CombinedStream 
 */
//=========================================================================================================
let wmoHeader = {
	FilesHeaderOffset:0,
...
//WebsocketMessageObject.LINE_BREAK = '\r\n';  //=========================================================
//WebsocketMessageObject.DEFAULT_CONTENT_TYPE = 'application/octet-stream'; //============================
...
WebsocketMessageObject.prototype.DecodeFiles = (dataFromServer) => {
	let hedr = readWmoHeader(dataFromServer);
